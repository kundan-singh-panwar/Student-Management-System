...
<head>
    ...
    <title>Update | Student Management System</title>
        ...
        <table style="text-align: center; " align="center" width="95%" border="1">
            ...
            <tr>
                ...
                <td><img src="uploadimg/<?php echo $data['image'];  ?>"
                        style="max-width:150px; padding:5px;  border: 5px solid black;" alt="Student image"></td>
                ...
                <td><a href="updateform.php?id=<?php echo $data['roll']; ?>" style="color:white;"> EDIT RECORD</a></td>
            </tr>
            <?php
                    }
                }
